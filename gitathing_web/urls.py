...
urlpatterns = patterns('',
    ...
    url(r'^login-openid/$', 'gitathing_web.views.login_openid', name = 'gitathing_login_openid'),
    url(r'^login/$', 'gitathing_web.views.login', name = 'gitathing_login'),
    url(r'^login-error/$', 'gitathing_web.views.login_error', name = 'gitathing_login_error'),
    url(r'^edit-profile/$', 'gitathing_web.views.edit_profile', name = 'gitathing_edit_profile'),
